...
- [x] **UI-01**: Project workspace tabs are grouped into logical sub-tabs to reduce top-level navigation clutter
...
- [x] **UI-04**: New projects are seeded with template placeholder content on creation
