...
- architecture vs arch_node vs integration:
  ...
  • arch_node = capability NODE within an "ADR Track" or "AI Assistant Track" architecture diagram (e.g., "Alert Intelligence", "Incident Intelligence", "Knowledge Sources") — use ONLY when document explicitly references these tracks
